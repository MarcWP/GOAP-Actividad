 ...
 IsClosed = isClosed;
        ...
        public BezierPath (IEnumerable<Vector3> points, bool isClosed = false, PathSpace space = PathSpace.xyz) {
            ...
            if (pointsArray.Length < 2) {
                ...
                pathSpeeds = new List<float> (new float[] { 0, 0 });
        ...
        public void AddSegmentToEnd (Vector3 anchorPos) {
            ...
            pathSpeeds.Add(pathSpeeds[pathSpeeds.Count - 1]);
            if (controlMode == ControlMode.Automatic) {
        ...
        public void AddSegmentToStart (Vector3 anchorPos) {
            ...
            pathSpeeds.Insert(0,pathSpeeds[0]);
        ...
        public void SplitSegment (Vector3 anchorPos, int segmentIndex, float splitTime) {
            ...
            int newSpeedIndex = (segmentIndex + 1) % pathSpeeds.Count;
            int numAngles = perAnchorNormalsAngle.Count;
            int numSpeeds = pathSpeeds.Count;
            ...
            pathSpeeds.Insert (newSpeedIndex, 0f);
        ...
        public void DeleteSegment (int anchorIndex) {
            ...
            if (NumSegments > 2 || !isClosed && NumSegments > 1) {
                ...
                pathSpeeds.RemoveAt (anchorIndex / 3);
        ...
        /// Get the desired camera speed of a particular anchor
        public float GetAnchorSpeed (int anchorIndex) {
            return pathSpeeds[anchorIndex];
        }
        ...
        /// Set the desired speed of the camera for a particular anchor
        public void SetAnchorSpeed (int anchorIndex, float speed) {
            if (pathSpeeds[anchorIndex] != speed) {
                pathSpeeds[anchorIndex] = speed;
                NotifyPathModified ();
            }
        }
